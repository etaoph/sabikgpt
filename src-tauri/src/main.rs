...
fn main() {
    ...
    let twitter = CustomMenuItem::new("twitter".to_string(), "Author on LinkedIn");
                ...
                SystemTrayEvent::MenuItemClick { id, .. } => match id.as_str() {
                    "twitter" => {
                        api::shell::open(
                            ...
                            "https://linkedin.com/in/ksaabique".to_string(),
                            None,
                        )
                        .unwrap();
                    }
                    "github" => {
                        api::shell::open(
                            &app.get_window("main").unwrap().shell_scope(),
                            "https://github.com/etaoph/sabikgpt-desktop".to_string(),
                            None,
                        )
                        .unwrap();
                    }
